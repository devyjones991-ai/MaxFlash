...
class InitialBalanceCalculator:
    ...
    def calculate_initial_balance(self, dataframe: pd.DataFrame) -> tuple[float, float]:
        """
    ...
    def is_price_in_ib(self, price: float, ib_high: float, ib_low: float, tolerance_pct: float = 0.001) -> bool:
        """
