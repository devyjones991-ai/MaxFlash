...
class TestRiskManager(unittest.TestCase):
    ...
    def test_calculate_stop_loss_long(self):
        ...
        self.assertLess(stop_loss, order_block_low)
        
        # With ATR only
        stop_loss_atr = self.risk_manager.calculate_stop_loss(
            entry_price, atr=atr, direction='long'
        )
        
        self.assertLess(stop_loss_atr, entry_price)
    ...
    def test_calculate_stop_loss_short(self):
        ...
        self.assertGreater(stop_loss, order_block_high)
        
        # With ATR only
        stop_loss_atr = self.risk_manager.calculate_stop_loss(
            entry_price, atr=atr, direction='short'
        )
        
        self.assertGreater(stop_loss_atr, entry_price)
    ...
    def test_calculate_take_profit_long(self):
        ...
        self.assertGreaterEqual(tp1, min_tp)
        
        # TP1 should use nearest HVN
        self.assertEqual(tp1, 105)
    ...
    def test_calculate_trailing_stop_long(self):
        ...
        self.assertGreaterEqual(new_stop, current_stop_loss)
        self.assertLessEqual(new_stop, current_price)
    ...
    def test_validate_trade(self):
        ...
        is_valid_invalid, reason_invalid = self.risk_manager.validate_trade(
            100, 100, 104
        )
