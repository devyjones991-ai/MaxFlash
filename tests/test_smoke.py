...
class TestSmokeImports:
    ...
    def test_import_api_models(self):
        ...
        from api.models import HealthResponse, OrderBlockModel, SignalModel, VolumeProfileModel
...
class TestSmokeAPI:
    ...
    def test_api_models_validation(self):
        ...
        health = HealthResponse(status="healthy", version="1.0.0", services={"test": "ok"})
    ...
    def test_version_in_api(self):
        ...
        try:
            ...
            assert version_from_module == VERSION
        except ImportError:
