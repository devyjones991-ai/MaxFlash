...
class TestOrderBlocks(unittest.TestCase):
    ...
    def test_detect_order_blocks(self):
        ...
        self.assertIn('ob_bullish_high', result.columns)
        self.assertIn('ob_bullish_low', result.columns)
        self.assertIn('ob_type', result.columns)
    ...
    def test_is_price_in_order_block(self):
        ...
        self.assertIsInstance(ob, (dict, type(None)))
    ...
    def test_invalidation(self):
        ...
        if pd.notna(last_ob_low):
            ...
            self.assertLess(last_close, last_ob_low)
