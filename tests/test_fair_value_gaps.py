...
class TestFairValueGaps(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.detector = FairValueGapDetector(
            min_size_pct=0.1,
            max_age_bars=50
        )
    ...
    def test_detect_fair_value_gaps(self):
        ...
        self.assertIn('fvg_bullish_high', result.columns)
        self.assertIn('fvg_bullish_low', result.columns)
        self.assertIn('fvg_type', result.columns)
        self.assertIn('fvg_strength', result.columns)
    ...
    def test_bullish_fvg_detection(self):
        ...
        self.assertGreater(len(bullish_fvgs.dropna()), 0)
    ...
    def test_is_price_in_fvg(self):
        ...
        self.assertIsInstance(fvg, (dict, type(None)))
