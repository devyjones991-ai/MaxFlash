...
def install_final_deps():
    ...
    try:
        ...
        print("Installing final dependencies...")
        ssh.exec_command("pip3 install pydantic-settings pydantic aiohttp aiosqlite --user --break-system-packages")
        time.sleep(10)
