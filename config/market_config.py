...
PRIORITY_EXCHANGES = ["binance", "okx", "bybit", "gate", "kraken", "bitget", "bingx", "htx", "bitmart", "coinbase"]
...
SECTOR_CLASSIFICATION: dict[str, list[str]] = {
    ...
    "Layer 2": ["ARB/USDT", "OP/USDT", "MATIC/USDT", "IMX/USDT", "METIS/USDT", "BOBA/USDT", "LRC/USDT", "DYDX/USDT"],
    "DeFi": [
        "UNI/USDT",
        "AAVE/USDT",
        "COMP/USDT",
    ...
    "Exchange Tokens": ["BNB/USDT", "FTT/USDT", "HT/USDT", "OKB/USDT", "KCS/USDT", "GT/USDT", "CRO/USDT", "LEO/USDT"],
    "Meme Coins": [
        "DOGE/USDT",
        "SHIB/USDT",
        "PEPE/USDT",
    ...
    "Privacy": ["XMR/USDT", "ZEC/USDT", "DASH/USDT", "ZEN/USDT"],
    "Stablecoins": ["USDT/USDT", "USDC/USDT", "DAI/USDT", "BUSD/USDT", "TUSD/USDT", "USDP/USDT", "USDD/USDT"],
    "Oracle": ["LINK/USDT", "BAND/USDT", "API3/USDT", "UMA/USDT", "DIA/USDT", "TRB/USDT", "PENDLE/USDT"],
    "Metaverse": ["SAND/USDT", "MANA/USDT", "AXS/USDT", "ENJ/USDT", "GALA/USDT", "TLM/USDT", "CHR/USDT", "ALICE/USDT"],
    "Storage": ["FIL/USDT", "AR/USDT", "STORJ/USDT", "SIA/USDT"],
    "Social": ["LENS/USDT", "GAL/USDT", "RSS3/USDT", "MASK/USDT"],
}
...
CACHE_CONFIG = {"ohlcv_ttl_minutes": 5, "ticker_ttl_minutes": 1, "markets_ttl_minutes": 30, "stats_ttl_minutes": 5}
...
CORRELATION_CONFIG = {"min_data_points": 100, "correlation_period_days": 30, "min_correlation_threshold": 0.5}
