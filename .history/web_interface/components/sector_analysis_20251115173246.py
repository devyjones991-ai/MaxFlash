...
from utils.market_data_manager import MarketDataManager  # noqa: E402
from utils.market_analytics import MarketAnalytics  # noqa: E402
...
try:
    ...
    def get_all_sectors():  # type: ignore  # noqa: F811
        return list(SECTOR_CLASSIFICATION.keys())

    def get_pairs_by_sector(sector: str):  # type: ignore  # noqa: F811
