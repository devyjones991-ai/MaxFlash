        ...
        cards.append(
            html.Div(
                ...
                children=[
                    ...
                    html.Div(f"${pair['price']:,.2f}", className="price-value"),
                    html.Div(
                        ["↑" if is_positive else "↓", f"{abs(pair['change']):.2f}%"],
                        className=f"price-change {'positive' if is_positive else 'negative'}",
                    ),
                    html.Div(
                        f"Vol: {pair['volume']}",
                        style={"fontSize": "0.75rem", "color": "var(--text-tertiary)", "marginTop": "0.5rem"},
                    ),
                ],
            )
        )
...
def create_modern_chart():
    ...
    fig.update_layout(
        ...
        xaxis={"gridcolor": "rgba(255, 255, 255, 0.1)", "showgrid": True, "zeroline": False},
        yaxis={"gridcolor": "rgba(255, 255, 255, 0.1)", "showgrid": True, "zeroline": False},
        hovermode="x unified",
    ...
    fig.update_xaxes(showspikes=True, spikecolor="#0ECB81", spikesnap="cursor", spikemode="across", spikethickness=1)

    fig.update_yaxes(showspikes=True, spikecolor="#0ECB81", spikesnap="cursor", spikemode="across", spikethickness=1)
            ...
            children=[
                ...
                html.Section(
                    ...
                    children=[
                        ...
                        html.Div(className="stats-grid", children=create_price_cards()),
                    ],
                ),
                # Статистика
                html.Section(
                    className="mb-4", children=[html.Div(className="stats-grid", children=create_stats_grid())]
                ),
                # График
                html.Section(
                    className="mb-4",
                                        ...
                                        html.Div(
                                            ...
                                            children=[
                                                html.Div(
                                                    ...
                                                    children=[
                                                        html.Div("LONG", className="signal-type long"),
                                                        html.Div(
                                                            "BTC/USDT @ $43,567.89",
                                                ...
                                                html.Div(
                                                    className="signal-item",
                                                    children=[
                                                        html.Div("SHORT", className="signal-type short"),
                                                        html.Div(
                                                            "ETH/USDT @ $2,645.12",
                                                            style={"fontWeight": "600", "marginBottom": "0.25rem"},
                                                        ),
                                        ...
                                        html.Div(
                                            ...
                                            children=[
                                                html.Div(
                                                    [
                                                        html.Span(
                                                            "Total P&L:", style={"color": "var(--text-secondary)"}
                                                        ),
                                                        html.Span(
                                                            " +$12,450.32",
                                                            style={
...
# Callbacks
@app.callback(
    Output("main-chart", "figure"), [Input("interval-component", "n_intervals"), Input("refresh-btn", "n_clicks")]
)
