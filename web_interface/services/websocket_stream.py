...
class WebSocketPriceStream:
    ...
    def __init__(self, exchange_name: str = "binance", api_key: Optional[str] = None, secret: Optional[str] = None):
        ...
        self.exchange_configs = {
            "binance": {"websocket_url": "wss://stream.binance.com:9443/ws/", "ticker_format": "{symbol}@ticker"},
            "bybit": {"websocket_url": "wss://stream.bybit.com/v5/public/spot", "ticker_format": "tickers.{symbol}"},
            "okx": {"websocket_url": "wss://ws.okx.com:8443/ws/v5/public", "ticker_format": "tickers.{symbol}"},
        }
    ...
    def _run_binance_stream(self):
        ...
        try:
            ...
            streams = [f"{symbol.replace('/', '').lower()}@ticker" for symbol in self.subscribers]
