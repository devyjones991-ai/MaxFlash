...
try:
    from components.help_system import create_help_button, create_help_modal, create_all_tooltips
except ImportError:
    from web_interface.components.help_system import create_help_button, create_help_modal, create_all_tooltips
