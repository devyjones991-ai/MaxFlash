...
try:
    ...
    from web_interface.components.multi_chart_view import (
        create_multi_chart_figure
    )
...
def register_multi_view_callbacks(app, data_manager=None):
    ...
    def update_symbol_inputs(
        _p1_btc, _p1_eth, _p1_sol, _p1_bnb,
        _p2_btc, _p2_eth, _p2_sol, _p2_bnb,
        _p3_btc, _p3_eth, _p3_sol, _p3_bnb,
        _p4_btc, _p4_eth, _p4_sol, _p4_bnb,
    ...
    def update_multi_charts(
        _update_clicks, _tf15m, _tf1h, _tf4h, _tf1d,
        symbol1, symbol2, symbol3, symbol4
    ):
        """
