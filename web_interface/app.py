...
app.layout = dbc.Container(
    [
                    ...
                    [
                        dbc.Row(
                            [
                                dbc.Col(
                                    [
                                        html.H3("📊 MaxFlash - Торговая Система", className="mb-0"),
                                        html.Small(
                                ...
                                dbc.Col(
                                    [
                                        dbc.ButtonGroup(
                                            [
                                                dbc.Button(
                                                    "🔄 Обновить", id="refresh-btn", outline=True, color="primary"
                                                ),
                                                dbc.Button(
                                                    "⚙️ Настройки", id="settings-btn", outline=True, color="secondary"
                                                ),
                                            ]
                                        ),
        ...
        dbc.Row([dbc.Col([dbc.Alert(id="status-alert", color="info", className="mb-2 py-2", dismissable=True)])]),
                                ...
                                dbc.CardHeader(
                                    [
                                        dbc.Row(
                                            [
                                                dbc.Col(
                                                    [html.H5("График цены с Order Blocks & FVG", className="mb-0")],
                                                    width="auto",
                                                ),
                                                dbc.Col(
                                                    [
                                                                        ...
                                                                        dbc.DropdownMenu(
                                                                            ...
                                                                            children=[
                                                                                dbc.DropdownMenuItem(
                                                                                    "BTC/USDT", id="quick-BTC-USDT"
                                                                                ),
                                                                                dbc.DropdownMenuItem(
                                                                                    "ETH/USDT", id="quick-ETH-USDT"
                                                                                ),
                                                                                dbc.DropdownMenuItem(
                                                                                    "SOL/USDT", id="quick-SOL-USDT"
                                                                                ),
                                                                                dbc.DropdownMenuItem(
                                                                                    "BNB/USDT", id="quick-BNB-USDT"
                                                                                ),
                                                                                dbc.DropdownMenuItem(
                                                                                    "XRP/USDT", id="quick-XRP-USDT"
                                                                                ),
                                                                                dbc.DropdownMenuItem(
                                                                                    "ADA/USDT", id="quick-ADA-USDT"
                                                                                ),
                                                                                dbc.DropdownMenuItem(
                                                                                    "DOGE/USDT", id="quick-DOGE-USDT"
                                                                                ),
                                                                                dbc.DropdownMenuItem(
                                                                                    "AVAX/USDT", id="quick-AVAX-USDT"
                                                                                ),
                                                                            ],
                    ...
                    [
                        ...
                        dbc.Card(
                            [
                                ...
                                dbc.CardBody(
                                    [dcc.Graph(id="volume-profile", style={"height": "200px"})], className="p-2"
                                ),
                            ],
                            className="mb-2",
                        ),
                        ...
                        dbc.Card(
                            [
                                ...
                                dbc.CardBody([html.Div(id="signals-panel")], className="p-2"),
                            ],
                            className="mb-2",
                        ),
                                        ...
                                        dbc.Modal(
                                            [
                                                ...
                                                dbc.ModalFooter(
                                                    [
                                                        dbc.Button(
                                                            "Закрыть", id="close-all-pairs-modal", className="ms-auto"
                                                        )
                                                    ]
                                                ),
                                            ],
                                    ...
                                    [
                                        dbc.InputGroup(
                                            [
                                                ...
                                                dbc.Button("➕", id="alert-add-btn", color="warning", size="sm"),
                                            ],
                                            size="sm",
                                        ),
                        ...
                        dbc.Card(
                            [
                                ...
                                dbc.CardBody([html.Div(id="metrics-panel")], className="p-2"),
                            ]
                        ),
                    ],
                    width=3,
...
def update_dashboard(_n_intervals, _refresh_clicks, _load_clicks, _existing_figure, symbol):
    ...
    try:
        ...
        # Status
        status_msg = f"✅ Система онлайн | Пара: {symbol} | Последнее обновление: {datetime.now().strftime('%H:%M:%S')}"
    ...
    try:
        if active_tab == "footprint":
            try:
                ...
                return html.Div([dcc.Graph(figure=create_footprint_chart(), style={"height": "350px"})])
            except ImportError:
            ...
            try:
                ...
                return html.Div([dcc.Graph(figure=create_market_profile_chart(), style={"height": "350px"})])
            except ImportError:
        ...
        if active_tab == "confluence":
            try:
                ...
                return html.Div([dcc.Graph(figure=create_confluence_map(), style={"height": "350px"})])
            except ImportError:
        ...
        if active_tab == "market-overview":
            try:
                ...
                msg = f"Market Overview компонент не найден: {e!s}"
                return html.Div([dbc.Alert(msg, color="info")])
        ...
        if active_tab == "multi-view":
            try:
                ...
                msg = f"Multi-View компонент не найден: {e!s}"
                return html.Div([dbc.Alert(msg, color="info")])
        ...
        if active_tab == "sector-analysis":
            try:
                ...
                msg = f"Sector Analysis компонент не найден: {e!s}"
                return html.Div([dbc.Alert(msg, color="info")])
...
try:
    ...
    if callbacks_path.exists():
        ...
        from callbacks.help_callbacks import register_help_callbacks
        from callbacks.market_overview_callbacks import register_market_overview_callbacks
        from callbacks.multi_view_callbacks import register_multi_view_callbacks
        from callbacks.price_alerts_callbacks import register_price_alerts_callbacks
        from callbacks.symbol_autocomplete_callbacks import register_symbol_autocomplete_callbacks
        from callbacks.watchlist_callbacks import register_watchlist_callbacks
    ...
    try:
        ...
        if ws_manager.is_available:
            ...
            def price_update_callback(price_data):
                ...
                logger.debug("Real-time обновление: %s = $%.2f", price_data.get("symbol"), price_data.get("price", 0))

            for symbol in popular_symbols:
                ws_manager.subscribe(symbol, price_update_callback)

            ws_manager.start()
            logger.info("WebSocket real-time обновления запущены для %s пар", len(popular_symbols))
        else:
