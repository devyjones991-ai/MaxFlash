                ...
                [
                    ...
                    dbc.CardBody(
                        [
                            dbc.InputGroup(
                                [
                                    dbc.Input(id="alert-symbol-input", placeholder="BTC/USDT", type="text", size="sm"),
                                    dbc.Input(
                                        id="alert-price-input", placeholder="Целевая цена", type="number", size="sm"
                                    ),
                                    dbc.Select(
                                    ...
                                    dbc.Button("➕", id="alert-add-btn", color="success", size="sm"),
                                ],
                                size="sm",
                                className="mb-3",
                            ),
