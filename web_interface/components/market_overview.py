...
try:
    from config.market_config import MARKET_OVERVIEW_CONFIG, POPULAR_PAIRS, get_sector_for_pair
except ImportError:
                                ...
                                [
                                    dbc.CardBody(
                                        [
                                            ...
                                            html.H2(
                                                f"{market_stats.get('total_pairs', 0):,}", className="text-primary"
                                            ),
                                            html.Small(
                                ...
                                [
                                    dbc.CardBody(
                                        [
                                            ...
                                            html.H2(
                                                f"{market_stats.get('btc_dominance', 0):.1f}%", className="text-warning"
                                            ),
                                        ]
                                    )
                                ]
                                ...
                                [
                                    dbc.CardBody(
                                        [
                                            ...
                                            html.H2(f"{market_stats.get('pairs_up_24h', 0)}", className="text-success"),
                                        ]
                                    )
                                ]
                            )
                                ...
                                [
                                    dbc.CardBody(
                                        [
                                            ...
                                            html.H2(
                                                f"{market_stats.get('pairs_down_24h', 0)}", className="text-danger"
                                            ),
                                        ]
                                    )
                                ]
                                ...
                                [
                                    dbc.CardBody(
                                        [
                                            ...
                                            html.H2(f"${market_stats.get('avg_price', 0):,.2f}", className="text-info"),
                                        ]
                                    )
                                ]
                            )
                                ...
                                [
                                    dbc.CardHeader(
                                        [
                                            ...
                                            dbc.InputGroup(
                                                [
                                                    dbc.Input(
                                                        id="pair-search-input", placeholder="Поиск пары...", type="text"
                                                    ),
                                    ...
                                    dbc.CardBody(
                                        [
                                            ...
                                            html.Div(create_pairs_table(tickers), id="pairs-table-container"),
                                        ]
                                    ),
                                ]
                            )
...
def create_crypto_heatmap(tickers: dict[str, dict[str, Any]]) -> go.Figure:
    ...
    # Создаем DataFrame
    df = pd.DataFrame({"Pair": pairs, "Change_24h": changes, "Volume": volumes})
...
def create_pairs_table(
    tickers: dict[str, dict[str, Any]], search_query: Optional[str] = None, display_limit: int = 50
) -> html.Div:
    """
    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.P(f"Показано {len(display_data)} из {total_count} пар", className="text-muted mb-2"),
                    dbc.Badge(f"Всего: {total_count}", color="info", className="ms-2"),
                ],
                className="mb-2",
            ),
            ...
            html.Div(
                [
                    ...
                    if has_more
                    else html.Div([dbc.Badge("Все пары загружены", color="success", className="mt-2")])
                ]
            ),
        ],
