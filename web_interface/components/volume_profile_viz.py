...
def create_volume_profile_chart(
    ...
    fig.add_trace(
        go.Bar(
            ...
            y=price_levels,
            orientation="h",
            marker={"color": volumes, "colorscale": "Blues", "showscale": True, "colorbar": {"title": "Volume"}},
            name="Volume",
    ...
    if hvn:
        ...
        fig.add_trace(
            go.Scatter(
                ...
                y=hvn,
                mode="markers",
                marker={"symbol": "triangle-up", "size": 10, "color": "green", "line": {"width": 2, "color": "white"}},
                name="HVN",
    ...
    if lvn:
        ...
        fig.add_trace(
            go.Scatter(
                ...
                y=lvn,
                mode="markers",
                marker={"symbol": "triangle-down", "size": 10, "color": "red", "line": {"width": 2, "color": "white"}},
                name="LVN",
